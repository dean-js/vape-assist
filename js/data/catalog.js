...
export const HARDWARE_CATALOG = [
  ...
  /* ---------------------------- More devices ---------------------------- */
  {
    ...
    tags: ["pod-system", "beginner-friendly", "mtl", "compact"],
    communityRating: 4.6,
    communityReviewCount: 428,
    isNew: false,
    popularity: 85,
    retailers: [
      { name: "MistVault", price: 21.99, inStock: true, url: "#" },
      { name: "Vapington", price: 20.99, inStock: true, url: "#" },
    ],
  },
  {
    id: "hw-uwell-caliburn-g3-pods",
    category: "pod",
    subtype: "built-in-coil",
    name: "Uwell Caliburn G3 Pods",
    brand: "Uwell",
    compatibleWith: ["hw-uwell-caliburn-g3"],
    ohmOptions: [0.8, 1.2],
    avgLifeDays: 10,
    tags: ["pod-system", "mtl", "built-in-coil"],
    communityRating: 4.5,
    communityReviewCount: 190,
    isNew: false,
    popularity: 63,
    retailers: [
      { name: "MistVault", price: 8.99, inStock: true, url: "#" },
      { name: "CloudHaus UK", price: 9.49, inStock: true, url: "#" },
    ],
  },
  {
    id: "hw-geekvape-z-coil",
    category: "coil",
    subtype: "mesh",
    name: "GeekVape Z Series Coil",
    brand: "GeekVape",
    compatibleWith: ["hw-geekvape-l200", "hw-hellbeast-tank"],
    ohmOptions: [0.15, 0.2, 0.4],
    avgLifeDays: 9,
    tags: ["mesh", "sub-ohm"],
    communityRating: 4.3,
    communityReviewCount: 112,
    isNew: false,
    popularity: 52,
    retailers: [
      { name: "VaporLane", price: 10.49, inStock: true, url: "#" },
      { name: "The Vape Yard", price: 9.99, inStock: true, url: "#" },
    ],
  },
];
...
export const LIQUID_CATALOG = [
  ...
  {
    id: "liq-vapington-mixed-berry-shortfill",
    name: "Mixed Berry Shortfill",
    brand: "Vapington",
    flavourCategory: "fruit",
    tags: ["fruit", "berry", "mixed-berry"],
    nicotineOptions: [0],
    ...
    bottleSizeMl: 50,
    communityRating: 4.5,
    communityReviewCount: 61,
    isNew: true,
    popularity: 50,
    retailers: [
      { name: "Vapington", price: 12.99, inStock: true, url: "#" },
    ],
  },
  {
    id: "liq-vapeyard-vanilla-custard",
    name: "Vanilla Custard",
    brand: "The Vape Yard",
    flavourCategory: "dessert",
    tags: ["dessert", "vanilla", "custard", "sweet"],
    nicotineOptions: [3, 6, 10, 20],
    vgPg: "50/50",
    bottleSizeMl: 10,
    communityRating: 4.3,
    communityReviewCount: 45,
    isNew: true,
    popularity: 39,
    retailers: [
      { name: "The Vape Yard", price: 3.29, inStock: true, url: "#" },
    ],
  },
  {
    id: "liq-podbase-energy-rush",
    name: "Energy Rush",
    brand: "PodBase UK",
    flavourCategory: "drinks",
    tags: ["drinks", "energy-drink"],
    nicotineOptions: [10, 20],
    vgPg: "50/50",
    bottleSizeMl: 10,
    communityRating: 4.4,
    communityReviewCount: 33,
    isNew: true,
    popularity: 42,
    retailers: [
      { name: "PodBase UK", price: 3.19, inStock: true, url: "#" },
    ],
  },
];
